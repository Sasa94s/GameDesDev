...
namespace UnityStandardAssets._2D
{
    public class Camera2DFollow : MonoBehaviour
    {
        ...
        public Vector3 offset; // constant offset for camera position
		...
		private void Update()
		{
            ...
            Vector3 aheadTargetPos = new Vector3(target.position.x, 0, target.position.z) + m_LookAheadPos + Vector3.forward*m_OffsetZ;
